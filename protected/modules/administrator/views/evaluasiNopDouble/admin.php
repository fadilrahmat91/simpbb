    ...
    <div class="col-md-6">
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          ...
          <a href="<?=Yii::app()->createAbsoluteUrl('administrator/evaluasiNopDouble/exportpdf/tahun/'.$model->tahun)?>" class="btn btn-app">
            <i class="fa fa-file-pdf-o"></i> Pdf
          </a>
          <a href="<?=Yii::app()->createAbsoluteUrl('administrator/evaluasiNopDouble/export/tahun/'.$model->tahun)?>" class="btn btn-app">
