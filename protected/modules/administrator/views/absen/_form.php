...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'id_ket'); ?>
		<?php echo $form->textField($model,'id_ket'); ?>
		<?php echo $form->error($model,'id_ket'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'id_matkul'); ?>
		<?php echo $form->textField($model,'id_matkul'); ?>
		<?php echo $form->error($model,'id_matkul'); ?>
	</div>
