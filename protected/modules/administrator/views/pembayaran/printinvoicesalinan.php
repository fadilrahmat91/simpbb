      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <div class="form_print" id="lihatdata">
             ...
             <div class="tanggalpembayaran"><p class="p_print"><?=$dataPembayaran[0]['TGL_PEMBAYARAN_SPPT']?></p></div>
             ...
             <div class="tglbyr"><p class="p_print"><?=$dataPembayaran[0]['TGL_PEMBAYARAN_SPPT']?></p></div>
             ...
             <div class="tglbyr2"><p class="p_print"><?=$dataPembayaran[0]['TGL_PEMBAYARAN_SPPT']?></p></div>
             <div class="jumlahygdibyr2 jumbayar-total"><p class="p_print"></p></div>
             <div class="tglbyr3"><p class="p_print"><?=$dataPembayaran[0]['TGL_PEMBAYARAN_SPPT']?></p></div>
             ...
             <div class="tglbyr4"><p class="p_print"><?=$dataPembayaran[0]['TGL_PEMBAYARAN_SPPT']?></p></div>
