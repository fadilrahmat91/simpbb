...
class InformasiSpptController extends Controller
{
  ...
  {
    return RolesMenu::actionRule('InformasiSppt'); 
  }
  ...
  public function actionCeknop($nop){
   ...
   // $nop =  Yii::app()->request->getPost('nop');
    ...
    if($nop !== ""){
      ...
      $url=Yii::app()->createUrl('administrator/InformasiSppt/index',array(
        'nop'=>$nop,
        ));
