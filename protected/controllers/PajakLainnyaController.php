...
*/
class PajakLainnyaController extends Controller
{
	...
	public function actionKetetapanPajak($tahun){
		$tahun = self::tahun($tahun);
		$type_pajak = KetetapanKecamatanSimpatda::TYPE_PAJAK;
		$ketetapan   = KetetapanKecamatanSimpatda::get_ketetapan_tahunan_chart($tahun,$type_pajak);
	...
	public function actionKetetapanRetribusi($tahun){
		$tahun = self::tahun($tahun);
	...
	public function actionRealisasiPajak($tahun){
		$tahun = self::tahun($tahun);
		$type_pajak = KetetapanKecamatanSimpatda::TYPE_PAJAK;
		
		$realisasi   = RealisasiKecamatanSimpatda::get_realisasi_tahunan_chart($tahun,$type_pajak);
		$jenis_pajak = JenisObjekPajakSimpatda::reArrangeJenisPajak($type_pajak);
		$charts = RealisasiKecamatanSimpatda::chartRealisasi("PAJAK",$tahun,$jenis_pajak,$realisasi);
		echo CJSON::encode($charts,JSON_NUMERIC_CHECK);
		return;
	}
	public function actionRealisasiRetribusi($tahun){
		$tahun = self::tahun($tahun);
		$type_pajak = KetetapanKecamatanSimpatda::TYPE_PAJAK_RETRIBUSI;
