...
$("document").ready(function(){
	...
	Ajax.run("<?=Yii::app()->createAbsoluteUrl('pajakLainnya/ketetapanPajak/tahun/'.$tahun)?>", 'GET', {},function(response){
	...
	Ajax.run("<?=Yii::app()->createAbsoluteUrl('pajakLainnya/ketetapanRetribusi/tahun/'.$tahun)?>", 'GET', {},function(response){
		var yAx = chartSerialize(response);
