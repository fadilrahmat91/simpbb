...
$("document").ready(function(){
	...
	Ajax.run("<?=Yii::app()->createAbsoluteUrl('pajakLainnya/realisasiPajak/tahun/'.$tahun)?>", 'GET', {},function(response){
	...
	Ajax.run("<?=Yii::app()->createAbsoluteUrl('pajakLainnya/realisasiRetribusi/tahun/'.$tahun)?>", 'GET', {},function(response){
		var yAx = chartSerialize(response);
