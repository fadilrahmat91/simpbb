        ...
        <div class="row text-center owl-carousel owl-theme">
				  ...
				  <ul class="list-group">
					<li class="list-group-item d-flex justify-content-between align-items-center">
						...
						<span class="badge badge-success badge-pill" style="position:relative">
							<?php 
								$data_pajak = KetetapanKecamatanSimpatda::get_ketetapan_tahunan($tahun,KetetapanKecamatanSimpatda::TYPE_PAJAK);
					  ...
					  <li class="list-group-item d-flex justify-content-between align-items-center">
						...
						<span class="badge badge-success badge-pill" style="position:relative">
						  <?php 
							$data_retribusi = KetetapanKecamatanSimpatda::get_ketetapan_tahunan($tahun,KetetapanKecamatanSimpatda::TYPE_PAJAK_RETRIBUSI);
          ...
          <div class="item">
			<div class="border-light-grey" style="background: #e2e9bb;">
				...
				<?php $realisasi_pajak = RealisasiKecamatanSimpatda::get_realisasi_tahunan($tahun,KetetapanKecamatanSimpatda::TYPE_PAJAK)?>
				<div class="list-group box-profile">
				  <ul class="list-group">
					<li class="list-group-item d-flex justify-content-between align-items-center">
						Realisasi
          ...
          <div class="item">
			<div class="border-light-grey" style="background: #e2e9bb;">
				...
				<?php $realisasi_pajak = RealisasiKecamatanSimpatda::get_realisasi_tahunan($tahun,KetetapanKecamatanSimpatda::TYPE_PAJAK_RETRIBUSI)?>
				<div class="list-group box-profile">
				  <ul class="list-group">
					<li class="list-group-item d-flex justify-content-between align-items-center">
						Realisasi
