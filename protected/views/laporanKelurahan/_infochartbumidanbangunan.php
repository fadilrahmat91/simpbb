      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">LUAS OBJEK</h2>
...
<script>
  $(document).ready(function(){
        Ajax.run("<?=Yii::app()->createAbsoluteUrl('laporanKelurahan/luasbumidanbangunan/kecamatan/'.$kecamatan.'/kelurahan/'.$kelurahan)?>", 'POST', {},function(response){
