    ...
    <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">KELURAHAN</h3>
          </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <form class="form-inline" action="<?php echo Yii::app()->createAbsoluteUrl('laporanKelurahan/laporan')?>">
...
$("document").ready(function(){
	$("select[name=kecamatan]").change(function(){
		...
		Ajax.run("<?=Yii::app()->createAbsoluteUrl('laporanKelurahan/getKelurahanbykecamatan')?>", 'GET', {kecamatan:kec},function(response){
			$("select[name=kelurahan]").html(response.html);
		});
	})
})
</script>