        ...
        <div class="row text-center owl-carousel owl-theme">
					  ...
					  <ul class="list-group">
						<li class="list-group-item d-flex justify-content-between align-items-center">
							...
							<span class="badge badge-success badge-pill">
							  <?php 
								$datalaporanketetapantahun = TotalTargetPajakKelurahan::getlaporanKelketetapantahun($tahun,$kecamatan,$kelurahan);
						  ...
						  <li class="list-group-item d-flex justify-content-between align-items-center">
							...
							<span class="badge badge-success badge-pill">
							  <?php 
								$datalaporanobjekpajaktahun = TotalTargetPajakKelurahan::getlaporanKelobjekpajaktahun($tahun,$kecamatan,$kelurahan);
          ...
          <div class="item">
			 <div class="border-light-grey" style="background: #e2e9bb;">
				...
				<?php $pembayaranRealisasi= TotalPembayaranPiutang::getRealisasiInfo($tahun,['kecamatan'=>$kecamatan,'kelurahan'=>$kelurahan])?>
				...
				<div class="list-group box-profile">
				  <ul class="list-group">
					<li class="list-group-item d-flex justify-content-between align-items-center">
					  ...
					  <?php $datalaporan_piutang = TotalPembayaranPiutang::getlaporanpiutang($tahun,['kecamatan'=>$kecamatan,'kelurahan'=>$kelurahan]); ?>
					  <li class="list-group-item d-flex justify-content-between align-items-center">
						Pembayaran Piutang
						<span class="badge badge-success badge-pill">
				...
				<div class="list-group box-profile">
				  <ul class="list-group">
					<li class="list-group-item d-flex justify-content-between align-items-center">
						...
						<span class="badge badge-success badge-pill">
						  <?php 
							$datalaporanbumitahun = TotalTargetPajakKelurahan::getlaporanKelbumitahun($tahun,$kecamatan,$kelurahan);
					  ...
					  <li class="list-group-item d-flex justify-content-between align-items-center">
						...
						<span class="badge badge-success badge-pill">
						  <?php 
							$datalaporanbangunantahun = TotalTargetPajakKelurahan::getlaporanKelbangunantahun($tahun,$kecamatan,$kelurahan);
