      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Informasi Realisasi dan Denda Kelurahan.</h3>
          </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
...
<script>
  $(document).ready(function(){
        Ajax.run("<?=Yii::app()->createAbsoluteUrl('maplaporan/realisasikelurahantahunini/tahun/'.$tahun)?>", 'POST', {},function(response){
