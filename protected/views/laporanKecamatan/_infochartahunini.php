        ...
        <div class="row text-center owl-carousel owl-theme">
				  ...
				  <ul class="list-group">
					<li class="list-group-item d-flex justify-content-between align-items-center">
						...
						<span class="badge badge-success badge-pill">
						  <?php 
							$datalaporanketetapantahun = TotalTargetPajakKabupaten::getlaporanKecketetapantahun($tahun,$kecamatan);
					  ...
					  <li class="list-group-item d-flex justify-content-between align-items-center">
						...
						<span class="badge badge-success badge-pill">
						  <?php 
							$datalaporanobjekpajaktahun = TotalTargetPajakKabupaten::getlaporanKecobjekpajaktahun($tahun,$kecamatan);
          ...
          <div class="item">
			  <div class="border-light-grey" style="background: #e2e9bb;">
				...
				<?php $pembayaranRealisasi= TotalPembayaranPiutang::getRealisasiInfo($tahun,['kecamatan'=>$kecamatan])?>
				...
				<div class="list-group box-profile">
				  <ul class="list-group">
					<li class="list-group-item d-flex justify-content-between align-items-center">
					  ...
					  <?php $datalaporan_piutang = TotalPembayaranPiutang::getlaporanpiutang($tahun,['kecamatan'=>$kecamatan]); ?>
					  <li class="list-group-item d-flex justify-content-between align-items-center">
						Pembayaran Piutang
						<span class="badge badge-success badge-pill">
					...
					<div class="list-group box-profile">
					  <ul class="list-group">
						<li class="list-group-item d-flex justify-content-between align-items-center">
							...
							<span class="badge badge-success badge-pill">
							  <?php 
								$datalaporanbumitahun = TotalTargetPajakKabupaten::getlaporanKecbumitahun($tahun,$kecamatan);
						  ...
						  <li class="list-group-item d-flex justify-content-between align-items-center">
							...
							<span class="badge badge-success badge-pill">
							  <?php 
								$datalaporanbangunantahun = TotalTargetPajakKabupaten::getlaporanKecbangunantahun($tahun,$kecamatan);
